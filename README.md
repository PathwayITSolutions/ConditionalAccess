...
* Conditions:  
  ...
  - Device Platforms:  
    ...
    - Exclude: **Android, iOS, WindowsPhone, Linux**    
  - Locations:  
  - Client apps:  
  - Filter for devices:  
  - Authentication flows:  
...
* Target resources:  
  - Resources (formerly cloud apps):  
    - Include: **Authentication context, c1**  
    - Exclude:  
* Network: No  
* Conditions:  
  - User Risk:  
...
* Target resources:  
  - Resources (formerly cloud apps):  
    - Include: **All resources**  
    - Exclude: **<ins>ServiceAccounts</ins>**  
* Network: No  
* Conditions:  
  - User Risk:  
  - Sign-in Risk:  
...
* Conditions:  
  ...
  - Filter for devices:  
  - Authentication flows:  
* Grant: **Grant access**, **Require authentication strength, Multifactor authentication, Require password change**, **Require all the selected controls** 
* Session: **Sign-in frequency, Every time** 

### CA022-Global-IdentityProtection-AllApps-AnyPlatform-MFA-Require MFA for Medium & High sign-in risk v1.0
* Users:  
  - Include: **All Users**  
  - Exclude: **<ins>Breakglass</ins>**, **<ins>ServiceAccounts</ins>**, **<ins>Admins</ins>**  
* Target resources:  
  - Resources (formerly cloud apps):  
    - Include: **All resources**  
    - Exclude:  
